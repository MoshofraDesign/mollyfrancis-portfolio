          ...
          {experience.map((job, i) => (
            ...
            >
              ...
              <div className="col-span-12 lg:col-span-9">
                ...
                <p className="text-base tracking-normal text-ink mb-5">
                  {job.period}
                </p>
          ...
          <div className="lg:col-span-9 space-y-8">
            {education.map((e) => (
              <Reveal key={e.school} as="div" className="grid grid-cols-12 gap-4">
                <p className="col-span-12 lg:col-span-4 text-base tracking-normal text-ink">
                  University
                </p>
              ...
              <ul className="col-span-12 lg:col-span-8 space-y-3">
                {recognition.map((r) => (
                  <li key={r.label}>
                    ...
                    {r.location && (
                      <span className="text-ink text-sm ml-2">
                        · {r.location}
                      </span>
                    )}
                  </li>
