...
function MediaPanel({
  ...
  return (
    <Panel
      ...
      /* 24rem of gutter, not 14: the extra 10rem is all on the trailing
         ...
         between. */
      width="lg:w-[min(100vw,calc(var(--beat-max-w)_+_24rem),calc(var(--panel-media-max-h)_*_var(--beat-aspect)_+_24rem))]"
      className="lg:!pr-[18rem]"
      pad="rail"
      style={
        {
