  ...
  return (
    ...
    >
      ...
      <HorizontalScroll>
        ...
        <section
          id="title"
          className="relative flex w-full flex-col gap-8 px-5 pb-10 pt-5 sm:px-8 sm:pt-7 lg:h-[100dvh] lg:w-screen lg:shrink-0 lg:snap-start lg:gap-12 lg:pl-[100px] lg:pr-[71px] xl:pr-[89px] 2xl:pr-[107px] lg:pt-16"
        >
